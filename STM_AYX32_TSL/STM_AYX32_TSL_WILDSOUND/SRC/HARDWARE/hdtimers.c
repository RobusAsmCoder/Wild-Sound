...
{
    CortexTimerDeltaProcedure(Timer_CounterX, MPU_ClocksStatus.SYSCLK_Frequency/1000000); //PCLK1_NOP);
...
u32 Timer_1mcs_CounterUpdate(void)
{
    ...
    #else
      CortexTimerDeltaProcedure(Timer_1mcs_CounterX, MPU_ClocksStatus.SYSCLK_Frequency/1000000);  //PCLK1_NOP*1000);
    #endif
...
u32 Timer_1ms_CounterUpdate(void)
{
    ...
    #else
      CortexTimerDeltaProcedure(Timer_1ms_CounterX, MPU_ClocksStatus.SYSCLK_Frequency / 1000);  //PCLK1_NOP*1000);
    #endif

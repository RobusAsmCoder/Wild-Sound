...
(*       Windows 32bit API registry interface unit              *)
(*       Based on regstr.h                                      *)
(*       Targets: WIN32 only                                    *)
(*                                                              *)
...
const
  ...
  REGSTR_KEY_ISAENUM_NEC_98 = 'C98PnP';
  REGSTR_KEY_EISAENUM_NEC_98 = 'NESA';
  ...
  DOSOPTF_DEFAULT = $00000001;
  DOSOPTF_SUPPORTED = $00000002;
  DOSOPTF_ALWAYSUSE = $00000004;
  DOSOPTF_USESPMODE = $00000008;
  DOSOPTF_PROVIDESUMB = $00000010;
  DOSOPTF_NEEDSETUP = $00000020;
  DOSOPTF_INDOSSTART = $00000040;
  DOSOPTF_MULTIPLE = $00000080;
  SUF_FIRSTTIME = $00000001;
  SUF_EXPRESS = $00000002;
  SUF_BATCHINF = $00000004;
  SUF_CLEAN = $00000008;
  SUF_INSETUP = $00000010;
  SUF_NETSETUP = $00000020;
  SUF_NETHDBOOT = $00000040;
  SUF_NETRPLBOOT = $00000080;
  SUF_SBSCOPYOK = $00000100;
  REGSTR_VAL_DOSPAGER = 'DOSPager';
  REGSTR_VAL_VXDGROUPS = 'VXDGroups';
  REGSTR_VAL_VPOWERDFLAGS = 'Flags';
  VPDF_DISABLEPWRMGMT = $00000001;
  VPDF_FORCEAPM10MODE = $00000002;
  VPDF_SKIPINTELSLCHECK = $00000004;
  VPDF_DISABLEPWRSTATUSPOLL = $00000008;
  ...
  PCMCIA_DEF_MEMBEGIN = $000C0000;
  PCMCIA_DEF_MEMEND = $00FFFFFF;
  PCMCIA_DEF_MEMLEN = $00001000;
  REGSTR_VAL_PCMCIA_ALLOC = 'AllocMemWin';
  REGSTR_VAL_PCMCIA_ATAD = 'ATADelay';
  REGSTR_VAL_PCMCIA_SIZ = 'MinRegionSize';
  PCMCIA_DEF_MIN_REGION = $00010000;
  ...
  REGDF_NOTDETIO = $00000001;
  REGDF_NOTDETMEM = $00000002;
  REGDF_NOTDETIRQ = $00000004;
  REGDF_NOTDETDMA = $00000008;
  REGDF_NOTDETALL = REGDF_NOTDETIO or REGDF_NOTDETMEM or REGDF_NOTDETIRQ or REGDF_NOTDETDMA;
  REGDF_NEEDFULLCONFIG = $00000010;
  REGDF_GENFORCEDCONFIG = $00000020;
  REGDF_NODETCONFIG = $00008000;
  REGDF_CONFLICTIO = $00010000;
  REGDF_CONFLICTMEM = $00020000;
  REGDF_CONFLICTIRQ = $00040000;
  REGDF_CONFLICTDMA = $00080000;
  REGDF_CONFLICTALL = REGDF_CONFLICTIO or REGDF_CONFLICTMEM or REGDF_CONFLICTIRQ or REGDF_CONFLICTDMA;
  REGDF_MAPIRQ2TO9 = $00100000;
  REGDF_NOTVERIFIED = $80000000;
  ...
  CONFIGFLAG_DISABLED = $00000001;
  CONFIGFLAG_REMOVED = $00000002;
  CONFIGFLAG_MANUAL_INSTALL = $00000004;
  CONFIGFLAG_IGNORE_BOOT_LC = $00000008;
  CONFIGFLAG_NET_BOOT = $00000010;
  CONFIGFLAG_REINSTALL = $00000020;
  CONFIGFLAG_FAILEDINSTALL = $00000040;
  CONFIGFLAG_CANTSTOPACHILD = $00000080;
  CONFIGFLAG_OKREMOVEROM = $00000100;
  CONFIGFLAG_NOREMOVEEXIT = $00000200;
  CSCONFIGFLAG_BITS = $00000007;
  CSCONFIGFLAG_DISABLED = $00000001;
  CSCONFIGFLAG_DO_NOT_CREATE = $00000002;
  CSCONFIGFLAG_DO_NOT_START = $00000004;
  DMSTATEFLAG_APPLYTOALL = $00000001;
  ...
  PCIC_DEFAULT_IRQMASK = $4EB8;
  PCIC_DEFAULT_IRQMASK_NEC_98 = $1468;

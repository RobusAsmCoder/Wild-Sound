...
(*       MCGA/VGA 13h Mode Graphics Unit                        *)
(*       Revision 2.0                                           *)
(*       Targets: MS-DOS 32-bit protected mode                  *)
(*                                                              *)
...
function  mGetPixAddr (X, Y: Word): Pointer; code;
    asm
      movzx     eax,[Y]
      shl       eax,6
      movzx     edi,[X]
...
procedure mFillScr(Color: Byte); assembler;
     asm
      mov       edi,[ScrAddr]
      cld
      movzx     eax,[Color]
...
procedure mPutScr (Buffer: Pointer); assembler;
    asm
      mov       edi,0A0000h
      mov       esi,[Buffer]
      push      ecx
...
procedure mGetScr (Buffer: Pointer); assembler;
    asm
      mov       esi,0A0000h
      mov       edi,[Buffer]
      push      ecx
...
procedure mPutPixel (X, Y: DWord; Color: Byte); code;
    asm
      mov       eax,[Y]
      shl       eax,6
      mov       edi,[X]
